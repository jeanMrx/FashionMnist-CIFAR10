...
train_data = FashionMNIST(root="./FashionMNIST",train=True,transform=transforms.ToTensor(),download=True)
#定义一个数据加载器
...
mynet,train_process = train_model(mynet,train_loader,Train_rate,criterion,optimizer,num_epochs=EPOCH )
...
# 计算混淆矩阵并可视化
conf_mat = confusion_matrix(test_data_y, test_result)
